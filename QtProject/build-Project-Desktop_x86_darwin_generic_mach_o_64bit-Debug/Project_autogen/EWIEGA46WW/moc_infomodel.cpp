...
#include <memory>
#include "../../../../../Downloads/dsba-itop2022-hw-master/QtProject/Project/infomodel.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_InfoModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_InfoModel_t qt_meta_stringdata_InfoModel = {
    {
QT_MOC_LITERAL(0, 9) // "InfoModel"
...
const QMetaObject InfoModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_InfoModel.offsetsAndSize,
    qt_meta_data_InfoModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_InfoModel_t
, QtPrivate::TypeAndForceComplete<InfoModel, std::true_type>
